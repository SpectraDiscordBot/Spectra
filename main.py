...
anti_spam = commands.CooldownMapping.from_cooldown(5, 40, commands.BucketType.member)
...
async def on_member_join(member):
    ...
    # Welcome messaging
    welcome_messaging = welcome_messages_collection.find_one(
...
async def on_message(message):
    ...
    custom_command = custom_cmds_collection.find_one(
    ...
    if antispam_guild:
        ...
        if retry_after:
            ...
            warning_entry = warning_collection.find_one(
    ...
    if interaction.type == discord.InteractionType.component:
        ...
        if custom_id.startswith("reports_ban"):
            ...
            if user:
                ...
                cases = cases_collection.find_one(
        ...
        if custom_id.startswith("reports_warn"):
            ...
            if user:
                ...
                data = warning_collection.find_one(
                    {"guild_id": str(interaction.guild.id)}
                )
